...
with sidebar:
    selected = option_menu(
        ...
        options=['Fouls Drawn Per 40','Per Minute Stats', 'Opponent Shot Chart'],
        icons=['basketball','stopwatch','pencil'],
        menu_icon='cast',
        default_index=0,
        styles={
        "container": {"padding": "0"},
...
if selected == 'Fouls Drawn Per 40':
    ...
    def main():
        ...
        components.html(html_temp, height = 800, width = 1000)
    
    if __name__ == "__main__":    
        main()
    
    st.markdown("""---""")
    url='https://drive.google.com/file/d/1yVtSbgO_7Z9yRq-EKQRbMlsdeKtN5pu7/view?usp=sharing'
